...
- Full pipeline, "autoplanからshipまで", "全部自動で", "plan to PR" → invoke fullship
- デザイン改善, "UI磨いて", "見た目を良くして", "デザイン整えて" → invoke design-flow
- バグ修正, "品質改善", "テストして直して", "動かないから調べて" → invoke bugfix
